...
public class MarksValueAdapter extends RecyclerView.Adapter<MarkValueItem> {
    private DetailActivity context;
    private List<Mark> marks;

    public MarksValueAdapter(DetailActivity context) {
        super();
    ...
    @Override
    public MarkValueItem onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        LayoutInflater mInflater = LayoutInflater.from(viewGroup.getContext());
        ViewGroup mainGroup = (ViewGroup) mInflater.inflate(R.layout.mark_value_item, viewGroup, false);
        MarkValueItem mainHolder = new MarkValueItem(mainGroup, context) {
            @Override
    ...
    @Override
    public void onBindViewHolder(MarkValueItem holder, int position) {
